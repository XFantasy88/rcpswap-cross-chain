...
export interface SlippageTabsProps {
  rawSlippage: string
  setRawSlippage: (rawSlippage: string) => void
  deadline: number
...
export default function SlippageTabs({
  ...
  const slippageInputIsValid =
    slippageInput === "" || +rawSlippage === +slippageInput
  ...
  function parseCustomSlippage(value: string) {
    ...
    try {
      const valueAsIntFromRoundedFloat = +value
      if (
        !Number.isNaN(valueAsIntFromRoundedFloat) &&
        valueAsIntFromRoundedFloat < 50
      ) {
        setRawSlippage(valueAsIntFromRoundedFloat.toString())
      }
    } catch {}
  }
      ...
      <AutoColumn gap="sm">
        ...
        <RowBetween>
          <Option
            ...
            active={parseFloat(rawSlippage) === 0.5}
          >
            0.5%
          </Option>
          <Option
            ...
            active={parseFloat(rawSlippage) === 2.5}
          >
            2.5%
          </Option>
          <Option
            ...
            active={parseFloat(rawSlippage) === 5}
          >
            5.0%
          </Option>
          <OptionCustom
          ...
          >
            <RowBetween>
              ...
              <Input
                ref={inputRef as any}
                placeholder={(+rawSlippage).toFixed(2)}
                value={slippageInput}
                onBlur={() => {
