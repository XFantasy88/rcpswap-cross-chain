...
export interface UniV3FactoryInterface extends utils.Interface {
  contractName: "UniV3Factory";
  functions: {
...
export interface UniV3Factory extends BaseContract {
  contractName: "UniV3Factory";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: UniV3FactoryInterface;
